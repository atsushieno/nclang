...
namespace NClang.Natives
{
	...
	static partial class LibClang
	{
		[DllImport (LibraryName)]
		 internal static extern CompletionChunkKind 	clang_getCompletionChunkKind (CXCompletionString completion_string, [MarshalAs (UnmanagedType.SysUInt)] uint chunk_number);

		[DllImport (LibraryName)]
		 internal static extern CXString 	clang_getCompletionChunkText (CXCompletionString completion_string, [MarshalAs (UnmanagedType.SysUInt)] uint chunk_number);

		[DllImport (LibraryName)]
		 internal static extern CXCompletionString 	clang_getCompletionChunkCompletionString (CXCompletionString completion_string, [MarshalAs (UnmanagedType.SysUInt)] uint chunk_number);
		...
		[DllImport (LibraryName)]
		 internal static extern CXString 	clang_getCompletionAnnotation (CXCompletionString completion_string, [MarshalAs (UnmanagedType.SysUInt)] uint annotation_number);
		...
		[DllImport (LibraryName)]
		internal static extern CXCodeCompleteResultsPtr 	clang_codeCompleteAt (CXTranslationUnit TU, string complete_filename, [MarshalAs (UnmanagedType.SysUInt)] uint complete_line, [MarshalAs (UnmanagedType.SysUInt)] uint complete_column,
			[MarshalAs (UnmanagedType.LPArray)] CXUnsavedFile[] unsaved_files, [MarshalAs (UnmanagedType.SysUInt)] uint num_unsaved_files,
			[MarshalAs (UnmanagedType.SysUInt)] CodeCompleteFlags options);

		[DllImport (LibraryName)]
		 internal static extern void 	clang_sortCodeCompletionResults (CXCompletionResultPtr Results, [MarshalAs (UnmanagedType.SysUInt)] uint NumResults);
		...
		[DllImport (LibraryName)]
		 internal static extern CXDiagnostic 	clang_codeCompleteGetDiagnostic (CXCodeCompleteResultsPtr Results, [MarshalAs (UnmanagedType.SysUInt)] uint Index);

		[DllImport (LibraryName)]
		 internal static extern SystemLongLong 	clang_codeCompleteGetContexts (CXCodeCompleteResultsPtr Results);

		[DllImport (LibraryName)]
		 internal static extern CursorKind 	clang_codeCompleteGetContainerKind (CXCodeCompleteResultsPtr Results, [MarshalAs (UnmanagedType.SysUInt)] out uint IsIncomplete);
